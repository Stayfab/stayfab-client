<?php
/*
Plugin Name: Uncode Visual Composer
Plugin URI: http://vc.wpbakery.com
Description: Extended version of Visual Composer - Drag and drop page builder for WordPress. Take full control over your WordPress site, build any layout you can imagine – no programming knowledge required.
Version: 4.12.1
