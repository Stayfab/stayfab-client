...
new WPUpdatesPluginUpdater_1452( 'http://wp-updates.com/api/2/plugin', plugin_basename(__FILE__) );
*/

if( !class_exists('WPUpdatesPluginUpdater_1146') ) {
    class WPUpdatesPluginUpdater_1146 {
    	...
    	function check_for_update( $transient ) {
    		...
    		if( is_object($response) && !empty($response) ) {
    			...
    			if( !$userpro->verify_purchase( userpro_get_option('userpro_code'), '13z89fdcmr2ia646kphzg3bbz0jdpdja', 'DeluxeThemes', '5958681' ) ){
