...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td><textarea name="mail_new_post_follow_m" id="mail_new_post_follow_m" class="large-text code" rows="10"><?php echo userpro_sc_get_option('mail_new_post_follow_m'); ?></textarea></td>
	</tr>
