...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td><textarea name="mail_verifyemail_change" id="mail_verifyemail_change" class="large-text code" rows="10"><?php echo userpro_get_option('mail_verifyemail_change'); ?></textarea></td>
	</tr>
...
<h3><?php _e('User Mail "New Connect Request" Mail','userpro'); ?></h3>
<table class="form-table">
...
<h3><?php _e('Admin "Notification email for verification request" Mail','userpro'); ?></h3>
<table class="form-table">
