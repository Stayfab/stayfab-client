...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			...
			<span class="description">'.__('Enter your MailChimp API key here to allow integration with MailChimp subscription.','userpro').'</span>
		</td>
	</tr>
...
<tr valign="top">
		...
		<td>
			...
			<span class="description">'. __('Enter your Aweber Authorization Code here to allow integration with Aweber subscription.','userpro').'</span>
...
<table class="form-table">
	...
	<th scope="row"><label for="Campaignmonitor_api">'.__('CampaignMonitor Authorization Code','userpro').'</label></th>
		...
		<span class="description">'.__('Enter your CampaignMonitor Authorization Code here to allow integration with Campaignmonitor subscription.','userpro').'</span>
	</td>
	</tr>
<tr valign="top">
