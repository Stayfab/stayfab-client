...
?>
<style>
	input#place_order{top:80px !important;}
</style>
<div id="order_review">
		...
		<div class="form-row place-order">
			...
			<?php if ( wc_get_page_id( 'terms' ) > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) { 
				...
				<p class="form-row terms">
					<label for="terms" class="checkbox"><?php _e( 'Jeg har læst og accepterer', 'woocommerce' ); ?> <a href="<?php echo esc_url( get_permalink(wc_get_page_id('terms')) ); ?>" target="_blank"><?php _e( 'betingelserne', 'woocommerce' ); ?></a></label>
					<input type="checkbox" class="input-checkbox" name="terms" <?php checked( $terms_is_checked, true ); ?> id="terms" />
				</p>
				<p class="form-row terms">
					<label for="newsletter" class="checkbox"><?php _e( 'Jeg vil gerne modtage nyhedsbreve', 'woocommerce' ); ?></label>
					<input type="checkbox" class="input-checkbox" name="newsletter" checked="checked" id="newsletter" />
				</p>
			<?php } ?>
...
<script type="text/javascript">
	jQuery("#ship-to-different-address-checkbox").click(function()
	{
		...
		{
			jQuery("#shop_to_company_addrees").click();
		}
	});
</script>