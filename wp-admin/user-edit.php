...
/*jQuery("#btn_insert_user_store").click( function()
           {
             console.log("Clicked");
           }
        );*/
...
function insert_into_store(userid,uaddr,ucity,ulat,ulong,ucountry,urate)
{
	
	console.log(userid+uaddr+ucity+ulat+ulong+urate);
	var data = 
				{

					'action': 'insert_into_store_action',
			...
			jQuery.post('<?php echo admin_url('admin-ajax.php'); ?>', data, function(response) 
			{
				if(response)
				{
					...
					jQuery("#wq_success_msg").html('User Has been inserted/updated into store');
				}
