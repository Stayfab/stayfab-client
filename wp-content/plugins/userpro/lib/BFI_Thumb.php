...
if ( ! class_exists( 'BFI_Thumb_1_3' ) ) {
	...
	class BFI_Thumb_1_3 {
	    ...
	    public static function thumb( $url, $params = array(), $single = true ) {
	        ...
	        $crop_only = isset( $params['crop_only'] ) ? $params['crop_only'] : false;
			$width = isset($params['width'])?$params['width']:null;
			$height = isset($params['height'])?$params['height']:null;	
			$crop = isset($params['crop'])?$params['crop']:null;
			$crop_x = isset($params['crop_x'])?$params['crop_x']:null;
			$crop_y = isset($params['crop_y'])?$params['crop_y']:null;
			$crop_height = isset($params['crop_height'])?$params['crop_height']:null;
			$crop_width = isset($params['crop_width'])?$params['crop_width']:null;
			$opacity = isset($params['opacity'])?$params['opacity']:null;
			$color = isset($params['color'])?$params['color']:null;
			$grayscale = isset($params['grayscale'])?$params['grayscale']:null;
			$negate = isset($params['negate'])?$params['negate']:null;
