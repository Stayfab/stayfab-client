...
<table class="form-table">
	...
	<tr valign="top">
			...
			<td>
				...
				<span class="description"><?php _e('Enter the Google map API key value. Generate your <a target="_blank" href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&reusekey=true">API Key</a>','userpro-gmap'); ?></span>
			</td>
	</tr>
</table>
